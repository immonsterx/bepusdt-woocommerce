...
final class BEpusdt_WC_I18n {
	...
	private static function zh_cn() {
		return array(
			...
			'Choose which BEpusdt trade types customers can click on the payment page. After saving, the plugin checks BEpusdt wallet availability and disables unconfigured wallets.' => self::u( '\u9009\u62e9\u5ba2\u6237\u53ef\u5728\u652f\u4ed8\u9875\u70b9\u51fb\u7684 BEpusdt \u4ea4\u6613\u7c7b\u578b\u3002\u4fdd\u5b58\u8bbe\u7f6e\u540e\uff0c\u63d2\u4ef6\u4f1a\u68c0\u67e5 BEpusdt \u94b1\u5305\u53ef\u7528\u6027\uff0c\u5e76\u7981\u7528\u672a\u914d\u7f6e\u94b1\u5305\u7684\u9009\u9879\u3002' ),
			'Wallet not configured in BEpusdt' => self::u( 'BEpusdt \u4e2d\u672a\u914d\u7f6e\u94b1\u5305' ),
			'Last BEpusdt wallet check: %s. Save settings to refresh.' => self::u( '\u4e0a\u6b21 BEpusdt \u94b1\u5305\u68c0\u67e5\uff1a%s\u3002\u4fdd\u5b58\u8bbe\u7f6e\u53ef\u5237\u65b0\u3002' ),
			'Save settings once after entering the API URL and token to check BEpusdt wallet availability.' => self::u( '\u586b\u5199 API URL \u548c Token \u540e\uff0c\u8bf7\u5148\u4fdd\u5b58\u4e00\u6b21\u8bbe\u7f6e\u4ee5\u68c0\u67e5 BEpusdt \u94b1\u5305\u53ef\u7528\u6027\u3002' ),
			'Last BEpusdt wallet check failed: %s' => self::u( '\u4e0a\u6b21 BEpusdt \u94b1\u5305\u68c0\u67e5\u5931\u8d25\uff1a%s' ),
			'BEpusdt did not return a trade ID.' => self::u( 'BEpusdt \u672a\u8fd4\u56de\u4ea4\u6613 ID\u3002' ),
			'Visual Payment Options' => self::u( '\u89c6\u89c9\u5316\u652f\u4ed8\u9009\u9879' ),
			'Visual payment options' => self::u( '\u89c6\u89c9\u5316\u652f\u4ed8\u9009\u9879' ),
			'Visual payment options only; no real payment functionality.' => self::u( '\u8996\u89ba\u5316\u9078\u9805\uff0c\u65e0\u5b9e\u8d28\u529f\u80fd\u3002' ),
			'Drag to reorder. Checked options are shown on the frontend in this order. Visual payment options only; no real payment functionality.' => self::u( '\u62d6\u52a8\u53ef\u6392\u5e8f\u3002\u5df2\u52fe\u9009\u9879\u4f1a\u6309\u6b64\u987a\u5e8f\u663e\u793a\u5728\u524d\u53f0\u3002\u8996\u89ba\u5316\u9078\u9805\uff0c\u65e0\u5b9e\u8d28\u529f\u80fd\u3002' ),
			...
			'No cryptocurrency wallet is currently available. Please contact the store owner.' => self::u( '\u5f53\u524d\u6ca1\u6709\u53ef\u7528\u7684\u52a0\u5bc6\u8d27\u5e01\u94b1\u5305\uff0c\u8bf7\u8054\u7cfb\u5546\u5e97\u7ba1\u7406\u5458\u3002' ),
			'After payment, this page will update automatically when the transaction is confirmed.' => self::u( '\u4ed8\u6b3e\u540e\uff0c\u4ea4\u6613\u786e\u8ba4\u65f6\u6b64\u9875\u9762\u4f1a\u81ea\u52a8\u66f4\u65b0\u3002' ),
			'This payment method is unavailable for the current address. Please choose USDT payment.' => self::u( '\u5f53\u524d\u5730\u5740\u65e0\u6cd5\u4f7f\u7528\u6b64\u652f\u4ed8\u65b9\u5f0f\uff0c\u8bf7\u9009\u62e9 USDT \u652f\u4ed8\u3002' ),
	...
	private static function zh_tw() {
		return array(
			...
			'Choose which BEpusdt trade types customers can click on the payment page. After saving, the plugin checks BEpusdt wallet availability and disables unconfigured wallets.' => self::u( '\u9078\u64c7\u5ba2\u6236\u53ef\u5728\u652f\u4ed8\u9801\u9ede\u64ca\u7684 BEpusdt \u4ea4\u6613\u985e\u578b\u3002\u5132\u5b58\u8a2d\u5b9a\u5f8c\uff0c\u5916\u639b\u6703\u6aa2\u67e5 BEpusdt \u9322\u5305\u53ef\u7528\u6027\uff0c\u4e26\u505c\u7528\u672a\u8a2d\u5b9a\u9322\u5305\u7684\u9078\u9805\u3002' ),
			'Wallet not configured in BEpusdt' => self::u( 'BEpusdt \u4e2d\u672a\u8a2d\u5b9a\u9322\u5305' ),
			'Last BEpusdt wallet check: %s. Save settings to refresh.' => self::u( '\u4e0a\u6b21 BEpusdt \u9322\u5305\u6aa2\u67e5\uff1a%s\u3002\u5132\u5b58\u8a2d\u5b9a\u53ef\u91cd\u65b0\u6574\u7406\u3002' ),
			'Save settings once after entering the API URL and token to check BEpusdt wallet availability.' => self::u( '\u586b\u5beb API URL \u548c Token \u5f8c\uff0c\u8acb\u5148\u5132\u5b58\u4e00\u6b21\u8a2d\u5b9a\u4ee5\u6aa2\u67e5 BEpusdt \u9322\u5305\u53ef\u7528\u6027\u3002' ),
			'Last BEpusdt wallet check failed: %s' => self::u( '\u4e0a\u6b21 BEpusdt \u9322\u5305\u6aa2\u67e5\u5931\u6557\uff1a%s' ),
			'BEpusdt did not return a trade ID.' => self::u( 'BEpusdt \u672a\u56de\u50b3\u4ea4\u6613 ID\u3002' ),
			'Visual Payment Options' => self::u( '\u8996\u89ba\u5316\u652f\u4ed8\u9078\u9805' ),
			'Visual payment options' => self::u( '\u8996\u89ba\u5316\u652f\u4ed8\u9078\u9805' ),
			'Visual payment options only; no real payment functionality.' => self::u( '\u8996\u89ba\u5316\u9078\u9805\uff0c\u65e0\u5b9e\u8d28\u529f\u80fd\u3002' ),
			'Drag to reorder. Checked options are shown on the frontend in this order. Visual payment options only; no real payment functionality.' => self::u( '\u62d6\u52d5\u53ef\u6392\u5e8f\u3002\u5df2\u52fe\u9078\u9805\u6703\u6309\u6b64\u9806\u5e8f\u986f\u793a\u5728\u524d\u53f0\u3002\u8996\u89ba\u5316\u9078\u9805\uff0c\u7121\u5be6\u8cea\u529f\u80fd\u3002' ),
			...
			'No cryptocurrency wallet is currently available. Please contact the store owner.' => self::u( '\u76ee\u524d\u6c92\u6709\u53ef\u7528\u7684\u52a0\u5bc6\u8ca8\u5e63\u9322\u5305\uff0c\u8acb\u806f\u7d61\u5546\u5e97\u7ba1\u7406\u54e1\u3002' ),
			'After payment, this page will update automatically when the transaction is confirmed.' => self::u( '\u4ed8\u6b3e\u5f8c\uff0c\u4ea4\u6613\u78ba\u8a8d\u6642\u6b64\u9801\u9762\u6703\u81ea\u52d5\u66f4\u65b0\u3002' ),
			'This payment method is unavailable for the current address. Please choose USDT payment.' => self::u( '\u7576\u524d\u5730\u5740\u7121\u6cd5\u4f7f\u7528\u6b64\u652f\u4ed8\u65b9\u5f0f\uff0c\u8acb\u9078\u64c7 USDT \u652f\u4ed8\u3002' ),
