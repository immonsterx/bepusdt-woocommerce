...
final class BEpusdt_WC_I18n {
	...
	private static function zh_cn() {
		return array(
			...
			'Choose a USDT Network' => self::u( '\u9009\u62e9 USDT \u7f51\u7edc' ),
			'Your order has been created. Select the network you want to pay with, then you will be redirected to the secure USDT checkout page.' => self::u( '\u8ba2\u5355\u5df2\u521b\u5efa\u3002\u8bf7\u9009\u62e9\u8981\u4f7f\u7528\u7684\u652f\u4ed8\u7f51\u7edc\uff0c\u968f\u540e\u5c06\u8df3\u8f6c\u5230\u5b89\u5168\u7684 USDT \u6536\u94f6\u53f0\u3002' ),
			'Order Total' => self::u( '\u8ba2\u5355\u603b\u989d' ),
			'Order Number' => self::u( '\u8ba2\u5355\u7f16\u53f7' ),
			'Order Date' => self::u( '\u8ba2\u5355\u65e5\u671f' ),
			'Payment Method' => self::u( '\u652f\u4ed8\u65b9\u5f0f' ),
			'Trade ID' => self::u( '\u4ea4\u6613 ID' ),
			'USDT Network' => 'USDT ' . self::u( '\u7f51\u7edc' ),
			'After payment, this page will update automatically when USDT confirms the transaction.' => self::u( '\u4ed8\u6b3e\u540e\uff0cUSDT \u786e\u8ba4\u4ea4\u6613\u65f6\u6b64\u9875\u9762\u4f1a\u81ea\u52a8\u66f4\u65b0\u3002' ),
			...
			'View USDT payment tutorial' => self::u( '\u67e5\u770b USDT \u652f\u4ed8\u6559\u5b66' ),
			'Payment confirmed. Refreshing order status...' => self::u( '\u4ed8\u6b3e\u5df2\u786e\u8ba4\uff0c\u6b63\u5728\u5237\u65b0\u8ba2\u5355\u72b6\u6001...' ),
			'Invalid payment request.' => self::u( '\u65e0\u6548\u7684\u652f\u4ed8\u8bf7\u6c42\u3002' ),
			'Selected USDT network is not available.' => self::u( '\u6240\u9009 USDT \u7f51\u7edc\u4e0d\u53ef\u7528\u3002' ),
			'Unable to create USDT payment. Please try again.' => self::u( '\u65e0\u6cd5\u521b\u5efa USDT \u652f\u4ed8\uff0c\u8bf7\u91cd\u8bd5\u3002' ),
			'USDT payment started on %s.' => self::u( 'USDT \u652f\u4ed8\u5df2\u901a\u8fc7 %s \u53d1\u8d77\u3002' ),
			'Awaiting customer to choose a USDT network.' => self::u( '\u7b49\u5f85\u5ba2\u6237\u9009\u62e9 USDT \u7f51\u7edc\u3002' ),
	...
	private static function zh_tw() {
		return array(
			...
			'Choose a USDT Network' => self::u( '\u9078\u64c7 USDT \u7db2\u8def' ),
			'Your order has been created. Select the network you want to pay with, then you will be redirected to the secure USDT checkout page.' => self::u( '\u8a02\u55ae\u5df2\u5efa\u7acb\u3002\u8acb\u9078\u64c7\u8981\u4f7f\u7528\u7684\u652f\u4ed8\u7db2\u8def\uff0c\u96a8\u5f8c\u5c07\u8df3\u8f49\u5230\u5b89\u5168\u7684 USDT \u6536\u9280\u53f0\u3002' ),
			'Order Total' => self::u( '\u8a02\u55ae\u7e3d\u984d' ),
			'Order Number' => self::u( '\u8a02\u55ae\u7de8\u865f' ),
			'Order Date' => self::u( '\u8a02\u55ae\u65e5\u671f' ),
			'Payment Method' => self::u( '\u652f\u4ed8\u65b9\u5f0f' ),
			'Trade ID' => self::u( '\u4ea4\u6613 ID' ),
			'USDT Network' => 'USDT ' . self::u( '\u7db2\u8def' ),
			'After payment, this page will update automatically when USDT confirms the transaction.' => self::u( '\u4ed8\u6b3e\u5f8c\uff0cUSDT \u78ba\u8a8d\u4ea4\u6613\u6642\u6b64\u9801\u9762\u6703\u81ea\u52d5\u66f4\u65b0\u3002' ),
			...
			'View USDT payment tutorial' => self::u( '\u67e5\u770b USDT \u652f\u4ed8\u6559\u5b78' ),
			'Payment confirmed. Refreshing order status...' => self::u( '\u4ed8\u6b3e\u5df2\u78ba\u8a8d\uff0c\u6b63\u5728\u91cd\u65b0\u6574\u7406\u8a02\u55ae\u72c0\u614b...' ),
			'Invalid payment request.' => self::u( '\u7121\u6548\u7684\u652f\u4ed8\u8acb\u6c42\u3002' ),
			'Selected USDT network is not available.' => self::u( '\u6240\u9078 USDT \u7db2\u8def\u4e0d\u53ef\u7528\u3002' ),
			'Unable to create USDT payment. Please try again.' => self::u( '\u7121\u6cd5\u5efa\u7acb USDT \u652f\u4ed8\uff0c\u8acb\u91cd\u8a66\u3002' ),
			'USDT payment started on %s.' => self::u( 'USDT \u652f\u4ed8\u5df2\u900f\u904e %s \u767c\u8d77\u3002' ),
			'Awaiting customer to choose a USDT network.' => self::u( '\u7b49\u5f85\u5ba2\u6236\u9078\u64c7 USDT \u7db2\u8def\u3002' ),
